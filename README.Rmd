...
`query_location_property_1` allows you to get the properties from the first type of query. The only parameter required here is the location Wikidata identifier. You can put it in an object or simply put it in quotes and put it in the function. If you want you can also add a language parameter (in the form of "fr" for French and so on). If you don't specify a language, English will be chosen as the default language.
...
2. `query_property_class` simply performs the query to Wikidata in order to get the class to which the property belongs to. The parameter to pass is the output of function at point 1. The files downloaded will be saved into *wikidata_classes* folder. If you want you can also add a language parameter (in the form of "fr" for French and so on). If you don't specify a language, English will be chosen as the default language.
